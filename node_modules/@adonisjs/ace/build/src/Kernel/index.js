...
class Kernel {
    ...
    async runDefaultCommand() {
        ...
        const commandInstance = this.application.container.make(this.defaultCommand, [this.application, this]);
    ...
    async exec(commandName, args) {
        ...
        if (!command) {
            throw InvalidCommandException_1.InvalidCommandException.invoke(commandName);
        }
